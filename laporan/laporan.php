...
<div class='panel panel-border panel-primary'>
    ...
    <!-- <tr height="30">
      ...
      <td><input name="dari" type="date"  value="Dari Tanggal" class="colorpicker-default form-control" size="12" id="datepicker-multiple1" /></td>
      <td><input name="ke" type="date"  value="sampai Tanggal" class="colorpicker-default form-control" size="12" id="datepicker-multiple2" /></td>
      </tr> -->
