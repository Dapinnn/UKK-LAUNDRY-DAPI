...
<li>
                            ...
                            <li>
                                <a href="?p=laporan" class="waves-effect"><i class="fa fa-book"></i><span> Laporan </span></a>
                            </li>
<?php } ?>
<?php } ?>
                        </ul>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="pull-left page-title">Aplikasi Laundry Dapi</h4>
                ...
                <footer class="footer text-right">
                    copyright &copy; 2022 Davina Shafa | Theme by Moltran.
                </footer>
