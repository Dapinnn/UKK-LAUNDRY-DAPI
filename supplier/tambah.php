...
<div class='panel panel-border panel-primary'>
                                    <div class='panel-heading'> 
                                        <h3 class='panel-title'><i class='fa fa-user-plus'></i> Tambah Owner</h3> 
...
$cekuser = mysql_query("SELECT * FROM pengguna WHERE username = '$username'");  
 ...
 echo "ERROR : Username sudah terdaftar";
	...
	$input = mysql_query("INSERT INTO pengguna VALUES(NULL, '$nama','$username', '$password', 'Owner', '$nik', '$alamat', '$telp', '$gender')") or die(mysql_error());
	if($input){
